#ifndef CONFIG_BOARD_701N_NANDFLASH_DEMO_CFG_H
#define CONFIG_BOARD_701N_NANDFLASH_DEMO_CFG_H

#include "board_701n_nandflash_demo_global_build_cfg.h"

#ifdef CONFIG_BOARD_701N_NANDFLASH_DEMO
...
#define TCFG_NORFLASH_SFC_DEV_ENABLE 		0//ENABLE_THIS_MOUDLE
#define TCFG_NORFLASH_DEV_ENABLE		    DISABLE_THIS_MOUDLE
#define TCFG_NANDFLASH_DEV_ENABLE		    ENABLE_THIS_MOUDLE	// nandflash 设备使能
#define TCFG_NANDFLASH_FAT_ENABLE		    ENABLE_THIS_MOUDLE	// nandflash fat分区使能，必须先使能 nandflash 设备
...
#define TCFG_EX_FLASH_POWER_IO_LEVEL        0	// 电源IO有效电平
#else
#define TCFG_EX_FLASH_POWER_IO_LEVEL        1
#endif
...
// 如果使能了nandflash设备，这里定义nandflash配置
#define TCFG_NANDFLASH_HEX_ID				0xc892	// flash ID, 十六进制值的字符串形式
...
#define TCFG_NANDFLASH_BLOCK_NUMBER		    2048
...
#define TCFG_NANDFLASH_FAT_ROOT				"fat_nand"			// fat16 分区的设备名
#define TCFG_NANDFLASH_FAT_BASE				(32 * 1024 * 1024)	// fat16 分区起始地址
#define TCFG_NANDFLASH_FAT_SIZE				(96 * 1024 * 1024)	// fat16 分区容量大小
#endif

#define TCFG_UI_RES_USE_FAT_FTL_ENABLE	   0
#define TCFG_UI_RES_FAT_FTL_ROOT			TCFG_NANDFLASH_FAT_ROOT
...
#define TCFG_UI_AVRCP_MUSIC_BG_ENABLE		ENABLE//avrcp传图（需使能USER_SUPPORT_PROFILE_BIP）
...
#endif //CONFIG_BOARD_701N_NANDFLASH_DEMO
#endif //CONFIG_BOARD_701N_NANDFLASH_DEMO_CFG_H
