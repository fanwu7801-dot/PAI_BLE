...
#define TCFG_FUNC_TINY_ENABLE				1 // 功能精简。关闭UI、本地播放、蓝牙发射、宜动健康APP等相关功能
...
#define TCFG_APP_MUSIC_EN			        (!TCFG_FUNC_TINY_ENABLE)
...
#define TCFG_APP_CAT1_EN                    0 // 用于4G通话
...
// cat1服务商
#define TCFG_CAT1_UNISOC_ENABLE             DISABLE // 展锐科技
#define TCFG_CAT1_AICXTEK_ENABLE			DISABLE // 归芯科技

// cat1 aicxtek
#if TCFG_CAT1_AICXTEK_ENABLE

#define TCFG_CAT1_AICXTEK_UART_TX			IO_PORTA_12 // 串口tx
#define TCFG_CAT1_AICXTEK_UART_RX			IO_PORTA_13 // 串口rx
#define TCFG_CAT1_AICXTEK_GPIO_WKUP			IO_PORTA_14 // 唤醒口。被CAT1激活
#define TCFG_CAT1_AICXTEK_GPIO_ACTIVE		IO_PORTA_15 // 激活CAT1

#define TCFG_CAT1_AICXTEK_GPIO_POWER		IO_PORTC_06 // power_key

// wkup index
#define PORT_WKUP_FALLING_IDX				6
#define PORT_WKUP_RISING_IDX				7

// cat1功能
#define TCFG_CAT1_FUNC_SMS_ENABLE			ENABLE	// 短信功能
#define TCFG_CAT1_FUNC_NET_ENABLE			ENABLE	// 网络功能

#define TCFG_CAT1_MODULE_UPDATE_ENABLE      ENABLE  // 支持cat1模块的固件升级
...
#define TCFG_CAT1_UNISOC_AP_REQ             IO_PORTG_00
#define TCFG_CAT1_UNISOC_AP_ACK             IO_PORTG_01
#define TCFG_CAT1_UNISOC_CP_REQ             IO_PORTG_06
#define TCFG_CAT1_UNISOC_CP_ACK             IO_PORTG_07
#define TCFG_CAT1_UNISOC_TP_ACK             IO_PORTC_06
#define TCFG_CAT1_UNISOC_CP_PBINT           IO_PORTC_07

#define PORT_AP_REQ_IDX                     5
#define PORT_AP_ACK_IDX                     6
#define PORT_CP_REQ_IDX                     7
#define PORT_CP_ACK_IDX                     8
#define PORT_CP_PBINT_IDX                   9

// cat1功能
#define TCFG_CAT1_FUNC_SMS_ENABLE			ENABLE	// 短信功能
#define TCFG_CAT1_FUNC_NET_ENABLE			ENABLE	// 网络功能

#define TCFG_CAT1_MODULE_UPDATE_ENABLE      ENABLE

#define TCFG_CAT1_UNISOC_BOARD_TEST       	1	// 测试样机
#define UNISOC_ESIM_TEST                  	0 	// 领科ESIM独立APP模式验证
...
#else // #if TCFG_CAT1_UNISOC_ENABLE

#define TCFG_CAT1_UNISOC_BOARD_TEST       0
#define UNISOC_ESIM_TEST                  0

#endif // #if TCFG_CAT1_UNISOC_ENABLE
...
#define TCFG_HW_SPI2_PORT_CLK   IO_PORTB_11
#define TCFG_HW_SPI2_PORT_DO    IO_PORTB_09
#define TCFG_HW_SPI2_PORT_DI    IO_PORTB_08
...
#define TCFG_HW_SPI2_ROLE       SPI_ROLE_SLAVE
#else
...
#define TCFG_USB_WEBUSB_ENABLE              0
...
#define TCFG_NOR_TONE_FAT                   DISABLE_THIS_MOUDLE
...
#define TCFG_VIRFAT_FLASH_ENABLE  			(!TCFG_FUNC_TINY_ENABLE)	// FLASH虚拟文件系统
#define TCFG_VIRFAT_INSERT_FLASH_ENABLE  	DISABLE	// 内置FLASH虚拟文件系统
#define TCFG_NOR_NEW_RES                  	DISABLE_THIS_MOUDLE

#define TCFG_SFC_VM                         DISABLE	// 内置FLASH自定义存储管理
...
#define TCFG_UI_RES_USE_FAT_FTL_ENABLE	    0
#if  (CONFIG_FLASH_SIZE == (16*1024*1024))
#if (TCFG_NOR_TONE_FAT && TCFG_FUNC_TINY_ENABLE)
#undef  TCFG_NORFLASH_SFC_DEV_ENABLE
#define TCFG_NORFLASH_SFC_DEV_ENABLE     	DISABLE

#undef  CONFIG_EXTERN_FLASH_SIZE
#define CONFIG_EXTERN_FLASH_SIZE            0

#undef  TCFG_VIRFAT_INSERT_FLASH_ENABLE
#define TCFG_VIRFAT_INSERT_FLASH_ENABLE 	ENABLE

#undef  TCFG_NOR_VM
#define TCFG_NOR_VM                         DISABLE_THIS_MOUDLE

#define TCFG_VIRFAT_INSERT_FLASH_BASE	  	0x7df000
#define TCFG_VIRFAT_INSERT_FLASH_SIZE	  	0x400000

#define TCFG_UI_VM_INSERT_FLASH_BASE	  	0xbdf000
#define TCFG_UI_VM_INSERT_FLASH_SIZE	  	CONFIG_EXTERN_USER_VM_FLASH_SIZE

#define TCFG_TONE_FAT_INSERT_FLASH_BASE	    0xdff000
#define TCFG_TONE_FAT_INSERT_FLASH_SIZE	  	CONFIG_EXTERN_USER_TONE_FAT_FLASH_SIZE

#define CONFIG_RULE_INSERT_FLASH_BASE	  	0x7df000
#define CONFIG_RULE_INSERT_FLASH_SIZE	  	0x400000
#define CONFIG_RULE_INSERT_UI_VM_BASE	  	0xbdf000
#define CONFIG_RULE_INSERT_UI_VM_SIZE	  	0x20000
#define CONFIG_RULE_INSERT_TONE_FAT_BASE	0xdff000
#define CONFIG_RULE_INSERT_TONE_FAT_SIZE	0x200000
#else
#if CONFIG_DOUBLE_BANK_ENABLE
#undef  TCFG_VIRFAT_INSERT_FLASH_ENABLE
#define TCFG_VIRFAT_INSERT_FLASH_ENABLE 	DISABLE// 双备份模式关闭内置FLASH资源FATFS，避免占用备份Bank并与外置资源包重复打包
#endif
...
/*PA*/
#if TCFG_CAT1_UNISOC_BOARD_TEST
#define TCFG_AUDIO_DAC_PA_PORT              IO_PORTA_04
#else
...
//                                 Audio Smart Voice                               //
//*********************************************************************************//
#define ASR_CFG_JL_KWS                      0   //杰理KWS离线语音识别
#define ASR_CFG_USER_DEFINED                1   //移植离线语音识别流程参考示例
#define ASR_CFG_AIS                         2   //aispeech离线语音识别 未使用
#define ASR_CFG_IFLYTEK                     3   //科大讯飞离线语音识别

#define TCFG_SMART_VOICE_ENABLE 		    DISABLE_THIS_MOUDLE      //ENABLE_THIS_MOUDLE
#define TCFG_AUDIO_ASR_DEVELOP              ASR_CFG_JL_KWS          //平台选择
...
#endif
#elif TCFG_AUDIO_ASR_DEVELOP == ASR_CFG_IFLYTEK
#define TCFG_CALL_IFLYTEK_SWITCH_ENABLE         TCFG_SMART_VOICE_ENABLE
#endif
...
#define TCFG_LCD_SPI_ST7789V_ENABLE_360x360 DISABLE_THIS_MOUDLE
#define TCFG_LCD_SPI_ST7789_BOE1_54_ENABLE  DISABLE_THIS_MOUDLE
#define TCFG_LCD_SPI_RM69330_ENABLE         DISABLE_THIS_MOUDLE
#define TCFG_LCD_SPI_SH8601A_ENABLE        (!TCFG_FUNC_TINY_ENABLE)
#define TCFG_LCD_QSPI_SD3302_ENABLE         DISABLE_THIS_MOUDLE
#define TCFG_LCD_SPI_CO5300_v1_ENABLE		DISABLE_THIS_MOUDLE
#define TCFG_LCD_SPI_SH8501A_ENABLE         DISABLE_THIS_MOUDLE
#define TCFG_LCD_RGB_ILI6485_ENABLE         DISABLE_THIS_MOUDLE
...
//clk强驱配置
#define TCFG_LCD_CLK_STRENGTH_ENABLE			ENABLE
#define TCFG_LCD_CLK_STRENGTH_PIN				IO_PORTA_07
#define TCFG_LCD_CLK_STRENGTH_LEVEL				1		//0 1 2 3
...
#define TCFG_LCD_TE_USED_PEND				DISABLE_THIS_MOUDLE//ENABLE_THIS_MOUDLE	// 使用信号量pend的方式等待TE
#if (TCFG_LCD_GC9307_240X283)
#define TCFG_LCD_TE_IO_PORT					IO_PORTA_05		// 定义TE脚
#else
#define TCFG_LCD_TE_IO_PORT					IO_PORTA_03		// 定义TE脚
#endif

#if (defined TCFG_LCD_TE_USED_PEND && TCFG_LCD_TE_USED_PEND)
// 使用 pend 信号量等 TE 时，需要注册一个 TE 中断
#define TCFG_LCD_TE_INT_INDEX				5	// TE 使用的中断索引
#endif

#define TCFG_SPI_LCD_ENABLE                 (!TCFG_FUNC_TINY_ENABLE) //spi lcd开关
#define TCFG_TFT_LCD_DEV_SPI_HW_NUM			1// 0: SPI0    1: SPI1    2: SPI2 配置lcd选择的spi口
#define TCFG_TOUCH_PANEL_ENABLE             (!TCFG_FUNC_TINY_ENABLE)//DISABLE
#define TCFG_TOUCH_USER_IIC_TYPE            0  //0:软件IIC  1:硬件IIC
#define TCFG_TP_CST816D_ENABLE              DISABLE_THIS_MOUDLE
#define TCFG_TP_BL6133_ENABLE               (!TCFG_FUNC_TINY_ENABLE)//注意: iic 时钟需小于200k。软件IIC，系统192Mhz，TCFG_SW_I2C0_DELAY_CNT需要大于70
#define TCFG_TP_FT3X68_ENABLE				DISABLE_THIS_MOUDLE//466屏幕触摸
...
#define TCFG_TP_SLEEP_EN					(!TCFG_FUNC_TINY_ENABLE)	// 触摸屏sleep使能
#define TP_POWER_DOWN_EN                    DISABLE  //tp掉电使能
#define LCD_POWER_DOWN_EN                   (!TCFG_FUNC_TINY_ENABLE)  //lcd屏掉电使能
...
#define TCFG_UI_SHUT_DOWN_TIME              (!TCFG_FUNC_TINY_ENABLE)
//0:不使用PWM控制背光
...
#define TCFG_UI_ENABLE_MOTO                 (!TCFG_FUNC_TINY_ENABLE)
...
#ifdef TCFG_LCD_SPI_SH8601A_ENABLE
#undef TCFG_LCD_SPI_SH8601A_ENABLE
#define TCFG_LCD_SPI_SH8601A_ENABLE				DISABLE_THIS_MOUDLE
#endif
#ifdef TCFG_LCD_SPI_ST7789V_ENABLE_360x360
#undef TCFG_LCD_SPI_ST7789V_ENABLE_360x360
#endif
#define TCFG_LCD_SPI_ST7789V_ENABLE_360x360     ENABLE_THIS_MOUDLE

#ifdef TCFG_TP_BL6133_ENABLE
#undef TCFG_TP_BL6133_ENABLE
#define TCFG_TP_BL6133_ENABLE				DISABLE_THIS_MOUDLE
#endif
#ifdef TCFG_TP_CST816D_ENABLE
#undef TCFG_TP_CST816D_ENABLE
#endif
#define TCFG_TP_CST816D_ENABLE              ENABLE_THIS_MOUDLE

#ifdef TCFG_TP_INT_IO
#undef TCFG_TP_INT_IO
#define TCFG_TP_INT_IO                     IO_PORTC_08
#endif

#ifdef TCFG_TP_RESET_IO
#undef TCFG_TP_RESET_IO
#define TCFG_TP_RESET_IO                   IO_PORTG_05
#endif

#ifdef TCFG_TP_POWER_IO
#undef TCFG_TP_POWER_IO
#define TCFG_TP_POWER_IO                   NO_CONFIG_PORT
#endif

#ifdef TCFG_MOTO_PWM_IO
#undef TCFG_MOTO_PWM_IO
#define TCFG_MOTO_PWM_IO                   IO_PORTB_06
#endif

#ifdef LCD_LOGO
#undef LCD_LOGO
#define LCD_LOGO                   "st7789v_360"
#endif
...
#define TCFG_LOWPOWER_LOWPOWER_SEL			SLEEP_EN           //芯片进入低功耗(UART0 RX唤醒)
...
#define TCFG_P11HR_HX3602_ALGO_ENABLE             0     //使用p11 sensor + 天意合芯心率算法
#define TCFG_P11HR_VC_ALGO_ENABLE				  0		//
...
#define TCFG_LOWER_POWEROFF_KEY_DISABLE			1 // 低电关机，关闭IO唤醒使能。（充电可唤醒）
...
#define TCFG_USER_EMITTER_TRANSMIT_A2DP_EN  0   //通过emitter转发音频
...
#define USER_SUPPORT_PROFILE_HFP    0   //禁用：VCU设备不需要手机通话音频
#define USER_SUPPORT_PROFILE_A2DP   0   //禁用：VCU设备不需要手机音乐音频
...
#define USER_SUPPORT_PROFILE_HFP_AG 0   //禁用：VCU设备不需要免提网关
...
#define CONFIG_USE_RANDOM_ADDRESS_ENABLE   1
#else
...
#define WECHAT_SPORT_ENABLE                 0 //微信运动数据上传
...
#define SMBOX_BLE_CLIENT_EN                 1 //主机功能
#define SMBOX_MULTI_BLE_SLAVE_NUMS          5 //range(0~1)
#define SMBOX_MULTI_BLE_MASTER_NUMS         2 //range(0~2)
#define CONFIG_BT_GATT_CONNECTION_NUM       SMBOX_MULTI_BLE_SLAVE_NUMS + SMBOX_MULTI_BLE_MASTER_NUMS+1
...
#define TCFG_AI_IFLY_LOCAL_TTS_ENABLE	DISABLE //科大讯飞离线TTS。需要找科大讯飞索取库和资源文件
...
#define TCFG_IFLYTEK_APP_SECRET         "xxx"
#define TCFG_IFLYTEK_APP_KEY            "xxx"
#define TCFG_IFLYTEK_APP_ID             "xxx"
#endif

#if TCFG_AI_INTERACTION_ENABLE || TCFG_IFLYTEK_ENABLE
...
// #if CAPTURE_MIX_WITH_IIS
// #undef TCFG_AUDIO_INPUT_IIS
// #define TCFG_AUDIO_INPUT_IIS                ENABLE_THIS_MOUDLE
// #endif
...
#define TCFG_IIS_MCLK_IO                    IO_PORTA_15
#define TCFG_SCLK_IO                        IO_PORTA_14
#define TCFG_LRCLK_IO                       IO_PORTA_13
#define TCFG_DATA0_IO                       IO_PORTA_12 //IIS输出IO
#define TCFG_DATA1_IO                       IO_PORTA_05 //IIS输入IO
...
#endif
#define TCFG_RTC_CLOSE_DEMO					DISABLE // 关闭rtc的demo，能省功耗。一般用于船运模式，使用时应该加上船运模式判断
...
#define TCFG_UI_ENABLE_MENU_STAR_NEW		ENABLE//新满天星
