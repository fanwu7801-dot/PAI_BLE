...
#endif
        //暂时注释掉,避免开发版上因电量检测问题无法ota
        // if (0 == get_charge_online_flag() && smart->low_battery_level && (get_self_battery_level() <= (smart->low_battery_level % 10))) { // 防止设置low_battery_level大于10
