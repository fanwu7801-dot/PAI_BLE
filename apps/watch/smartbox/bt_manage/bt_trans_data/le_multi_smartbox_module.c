...
static const u8 local_test_sn_hex8[8] = {
    0x00, 0x02, 0x7C, 0xBD, 0x35, 0xDF, 0x21, 0x71,
};
...
static void f6f1_delay_send_handler(void)
{
    ...
    static u8 f6f1_data[] = {
        ...
        'S', 'W', '_', 'V', '1', '.', '0', 0x00,
        'H', 'W', '_', 'V', '1', '.', '2', 0x00,
        0x00, 0x02, 0x7C, 0xBD, 0x35, 0xDF, 0x21,0x71,// SN 位置从第19个字节开始，�?字节--->new sn 
...
{     static const u8 custom_adv_data[] = {
      ...
      0x0A, 0x09, 0x50, 0x41, 0x49, 0x42, 0x54, 0x30, 0x30, 0x31, 0x37  // 设备名称: "PAIBT0024" (大写)---> 蓝牙sn码后4位，默认值
  };
