...
/* Enable demo that tests USER reserved area read/write/erase.
 * Keep it disabled by default to avoid accidental boot-time demo tasks/log spam.
 * Enable it only when you really need to test USER area.
 */
// #define USER_INFO_DEMO
...
/*预编译冲突提示*/
#if APP_ONLINE_DEBUG && defined(CONFIG_APP_BT_ENABLE)
