...
const struct audio_dec_format_hdl decode_format_list[] = {
    ...
    // 自定义音效区域的文件名没有后缀，get_file_ext_name 返回最后3个字符
    // uwtg0 -> tg0, UWTG1 -> TG1, UWTG2 -> TG2, UWTG3 -> TG3
    // 映射到 WAV 解码（文件头为 RIFF...WAVE）
    {"tg0", AUDIO_CODING_WAV},
    {"tg1", AUDIO_CODING_WAV},
    {"tg2", AUDIO_CODING_WAV},
    {"tg3", AUDIO_CODING_WAV},
    {"TG0", AUDIO_CODING_WAV},
    {"TG1", AUDIO_CODING_WAV},
    {"TG2", AUDIO_CODING_WAV},
    {"TG3", AUDIO_CODING_WAV},
